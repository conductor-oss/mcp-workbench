        ...
        <div className="max-w-5xl mx-auto p-6 space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <section className="space-y-6">
                <div className="flex items-center gap-3">
                    <BookOpen className="w-8 h-8 text-terminal-cyan" />
                    <h1 className="text-3xl font-bold text-terminal-text">Learn Model Context Protocol</h1>
                </div>
                <p className="text-terminal-text-muted text-lg max-w-3xl leading-relaxed">
            ...
            <section className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                    <h2 className="text-xl font-bold text-terminal-text flex items-center gap-2">
                        <PlayCircle className="w-5 h-5 text-terminal-cyan" />
                        Getting Started
                    </h2>
                ...
                <div className="space-y-4">
                    <h2 className="text-xl font-bold text-terminal-text flex items-center gap-2">
                        <Book className="w-5 h-5 text-terminal-cyan" />
                        Advanced Topics
                    </h2>
                    <div className="grid gap-4">
                        <ArticleCard
            ...
            <div className="bg-terminal-surface/20 rounded-xl p-8 text-center space-y-4">
                <h3 className="text-lg font-bold text-terminal-text">Ready to build?</h3>
                <p className="text-terminal-text-muted">Join the community and start contributing to the future of context-aware AI.</p>
                <a
                    href="https://join.slack.com/t/orkes-conductor/shared_invite/zt-3dpcskdyd-W895bJDm8psAV7viYG3jFA"
                    className="inline-flex items-center gap-2 bg-terminal-cyan text-white px-6 py-2 rounded-lg font-bold hover:bg-opacity-90 transition-colors shadow-lg"
                >
                    Join Orkes Slack
...
const ArticleCard: React.FC<{ title: string; description: string; link: string }> = ({ title, description, link }) => (
    <a
        ...
        className="block p-4 bg-terminal-surface/30 rounded-lg hover:bg-terminal-surface/50 transition-all group"
    >
        <div className="flex justify-between items-start mb-2">
            <h4 className="font-bold text-terminal-text group-hover:text-terminal-cyan transition-colors">{title}</h4>
            <ExternalLink className="w-4 h-4 text-terminal-text group-hover:text-terminal-cyan transition-colors" />
        </div>
        <p className="text-sm text-terminal-text-muted leading-relaxed">{description}</p>
    </a>
);
